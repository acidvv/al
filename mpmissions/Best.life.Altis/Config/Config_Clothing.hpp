...
class Clothing {
	...
	class  sDiamante {
        ...
        uniforms[] = {
			...
			{ "U_NikosAgedBody", "Suit", 5000, { "", "", -1 } },
			{ "U_C_Man_casual_2_F", "dlc", 8500, { "", "", -1 } },
			{ "U_C_Man_casual_4_F", "dlc", 13500, { "life_donorlevel", "SCALAR", 5 } },
			{ "U_C_Man_casual_5_F", "dlc", 14500, { "life_donorlevel", "SCALAR", 5 } },
			{ "U_C_Man_casual_6_F", "dlc", 15500, { "life_donorlevel", "SCALAR", 5 } },
			{ "U_C_man_sport_1_F", "dlc", 16500, { "life_donorlevel", "SCALAR", 5 } },
			{ "U_C_man_sport_2_F", "dlc", 17500, { "life_donorlevel", "SCALAR", 5 } },
			{ "U_C_man_sport_3_F", "dlc", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "max_fire_uniform", "strażak", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "pilot_bLACK_uniform", "ciuchy ", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "pilot_blue_uniform", "ciuchy ", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "pilot_green_uniform", "ciuchy  ", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "pilot_red_uniform", "ciuchy ", 18500, { "life_donorlevel", "SCALAR", 5 } },
            { "vip2_uniform_new", "garniturek", 28500, { "life_donorlevel", "SCALAR", 5 } },
            { "vip1_uniform_new", "garniturek", 28500, { "life_donorlevel", "SCALAR", 5 } },
            { "vip3_uniform_new", "garniturek", 28500, { "life_donorlevel", "SCALAR", 5 } },
            { "Killer_uniform_new", "garniak", 28500, { "life_donorlevel", "SCALAR", 5 } }, 
            { "Robber_uniform_new", "garniak", 28500, { "life_donorlevel", "SCALAR", 5 } },
            { "skull_gang", "miejski gangster", 28500, { "life_donorlevel", "SCALAR", 5 } },
            { "druglord_uniform_new", "diler", 28500, { "life_donorlevel", "SCALAR", 5 } },
    ...
    class reb {
        ...
        vests[] = {
            ...
            { "V_HarnessOGL_brn", "Allah", 3000000, { "", "", -1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_OutdoorPack_blk", "", 2000, { "", "", -1 } },
