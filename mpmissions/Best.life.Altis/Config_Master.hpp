...
/* Database Related Settings */
    ...
    "defibrillator","toolkit","zipties","knife","pliers","kidney","nitroamine","sight","trigger","boltcutter","nitro","gpstracker","woodaxe","feuerwerkred", "feuerwerkblue","feuerwerkgreen","feuerwerkwhite"};  //Array of virtual items that can be saved on your player.
...
/* System Settings */
  ...
  /* Channel 7 News Station Configurations */
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "O_MRAP_02_hmg_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
        ...
        vehicle_chopShop_multiplier = .10; //Chop Shop price for vehicles. TO AVOID EXPLOITS NEVER SET HIGHER THAN A PURCHASE/RENTAL multipler!   Payout = Config_vehicle Price * multiplier
