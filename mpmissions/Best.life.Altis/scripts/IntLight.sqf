...
IL_config = IL_config + [
 ...
 [["B_Truck_01_transport_F","Truck_01_base_F","Jonzie_Box_Truck","Jonzie_Flat_Bed","SLB2k11_Scania_420_black","SLB2k11_Scania_420EU_orange","SLB2k11_Scania_420EU_blau","shounka_a3_dafxf_euro6_f"], false, [
 [ [0,4,0.42], IL_c_orange, IL_att_soft, 10]
 ],false],
...
IL_text_ON = "<t color='#FF0000'>Włącz oświetlenie wnętrza</t>";
IL_text_OFF = "<t color='#FF0000'>Wyłącz oświetlenie wnętrza</t>";
IL_Green_Text = "<t color='#00FF00'>Przełącz się na zielone</t>";
IL_Red_Text = "<t color='#FF0000'>Przełącz się na czerwone</t>";
IL_action = -1;
IL_lastchange = 0;
// Funktion
IL_fnc_inList = {
