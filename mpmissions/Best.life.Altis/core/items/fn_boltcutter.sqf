...
if (((nearestObject [[7362.12,7575.83,0.00266576],"Land_Dome_Big_F"]) == _building || (nearestObject [[7362.12,7575.83,0.00266576],"Land_Research_house_V1_F"]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    hint format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))]
};
if ((typeOf _building) == "Land_Research_house_V1_F" && (nearestObject [[7362.12,7575.83,0.00266576],"Land_Dome_Big_F"]) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"};
