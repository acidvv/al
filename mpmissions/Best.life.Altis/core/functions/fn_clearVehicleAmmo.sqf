...
if(EQUAL(_veh,"B_Boat_Armed_01_minigun_F")) then {
	...
	_vehicle removeMagazinesTurret ["2000Rnd_65x39_belt_Tracer_Red",[25]];
};

if(EQUAL(_veh,"I_Boat_Armed_01_minigun_F")) then {
	_vehicle removeMagazinesTurret ["200Rnd_40mm_G_belt",[1]];
	_vehicle removeMagazinesTurret ["2000Rnd_65x39_Belt_Tracer_Yellow",[25]];
};
...
if(EQUAL(_veh,"B_Heli_Transport_01_F")) then {
	_vehicle removeMagazinesTurret ["2000Rnd_65x39_Belt_Tracer_Red",[500]];
