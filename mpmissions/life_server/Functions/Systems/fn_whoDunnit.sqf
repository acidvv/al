...
[1,format["Suicide Message: %1 has killed %2 (Possibly suicide or disconnect)",_killer getVariable["realname",name _killer], _victim getVariable["realname",name _victim]]] remoteExec ["life_fnc_broadcast",nil];
		} else {
...
[1,format["Death Message: %1 has killed %2 with Weapon %3 from Distance %4 Meters",_killer getVariable["realname",name _killer], _victim getVariable["realname",name _victim], _killerWep, _distance]] remoteExec ["life_fnc_broadcast",nil];
	};
};
