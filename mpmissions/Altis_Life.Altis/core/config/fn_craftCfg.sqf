...
switch(_craft) do
{
	case "weapon":
	{
		_return = [
				...
				["hgun_Rook40_F", ["steel",6,"barrel",1,"trigger",1,"goldcoin",10]],
				["hgun_Pistol_heavy_02_F", ["steel",9,"barrel",1,"trigger",1,"goldcoin",10]],
				["arifle_TRG21_F", ["steel",15,"barrel",2,"trigger",1,"butt",2,"sight",1,"goldcoin",10]],
				["LMG_Zafir_F", ["steel",32,"barrel",4,"trigger",1,"butt",2,"sight",2,"goldcoin",10]],
				["srifle_DMR_01_F", ["steel",28,"barrel",5,"trigger",1,"butt",5,"sight",5,"goldcoin",10]]
		 ];
	};
	...
	{
         _return = [
				["U_O_Wetsuit",["cloth",5,"rubber",3,"goldcoin",10]],
				["U_O_CombatUniform_oucamo",["cloth",11,"goldcoin",10]],
				["U_B_GhillieSuit",["cloth",20,"goldcoin",10]],
				["U_O_FullGhillie_sard",["cloth",30,"goldcoin",10]]
        ];
	};
	...
	{
        _return = [
				["B_Kitbag_cbr",["cloth",25,"goldcoin",10]]
			];
	};
    ...
    case "vest":
    {
        ...
        ["V_PlateCarrierL_CTRG",["cloth",16,"steelplate",2,"goldcoin",10]],
				["V_HarnessOGL_brn",["cloth",35,"sulfur",25,"C4",12,"trigger",1,"goldcoin",10]]
        ];
    };
    case "ammo":
    {
        _return = [
        ["150Rnd_762x54_Box_Tracer",["iron_refined",15,"gunpowder",22,"goldcoin",10]],
		["30Rnd_556x45_Stanag_Tracer_Red",["iron_refined",15,"gunpowder",16,"goldcoin",10]],
		["10Rnd_762x54_Mag",["iron_refined",25,"gunpowder",30,"goldcoin",10]]
      	];
    };
    ...
    case "attach":
    {
        ...
        ["FirstAidKit",["cloth",3,"goldcoin",10]]
			];
		};
	};
	_return;
